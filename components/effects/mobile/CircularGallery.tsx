console.log("DEBUG: CircularGallery.tsx file loaded");
...
interface AppConfig {
  ...
  scrollSpeed?: number;
  scrollEase?: number;
  onItemClick?: (item: { image: string; text: string, href?: string }) => void;
}
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      },
      {
        ...
        text: 'Winter Classics'
      },
      {
        image: `https://images.unsplash.com/photo-1441984904996-e0b6ba687e12?q=80&w=800&auto=format&fit=crop`,
        text: 'London Fog'
      },
      {
        image: `https://images.unsplash.com/photo-1520975954732-45dd21d83192?q=80&w=800&auto=format&fit=crop`,
        text: 'Silent Warmth'
      },
      {
...
export default function CircularGallery({
  ...
  useEffect(() => {
    console.log("CircularGallery: mounting...", containerRef.current);
