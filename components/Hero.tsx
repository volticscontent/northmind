    ...
    <section className="relative h-[90dvh] md:h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <FrameSequence
          ...
          basePath={
            isMobile
              ? "/assets/hero-frames/mobile"
              : "/assets/hero-frames/desktop"
          }
          frameCount={492}
          fps={40}
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl animate-fade-in">
        ...
        <p className="text-xs md:text-base text-white/60 max-w-xl mx-auto mb-8 md:mb-12 font-medium tracking-wide leading-relaxed">
          Discover the harmony between classic British design and contemporary
          sophistication. Essentials crafted to last for generations.
        </p>
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 w-full md:w-auto">
          ...
          <Link
            ...
            className="text-[10px] font-bold uppercase tracking-luxury text-white/80 hover:text-white transition-all duration-300 px-6 py-4 active:text-accent min-h-[44px] flex items-center"
          >
            View Lookbook
          </Link>
        </div>
