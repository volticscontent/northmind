      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="grid grid-cols-1 gap-4">
            ...
            <li>
              <Link href="/faq" className="text-sm text-white/40 hover:text-accent transition-colors uppercase tracking-widest text-[10px] font-bold">
                Common Inquiries
              </Link>
            </li>
            <li>
            ...
            <li>
             ...
             <li>
              <Link href="/warranty" className="text-sm text-white/40 hover:text-accent transition-colors uppercase tracking-widest text-[10px] font-bold">
                Warranty
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h4 className="text-white text-xs uppercase font-bold tracking-widest mb-6">Legal</h4>
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/terms" className="text-sm text-white/40 hover:text-accent transition-colors uppercase tracking-widest text-[10px] font-bold">
                Terms & Conditions
              </Link>
            </li>
            <li>
              <Link href="/cookies" className="text-sm text-white/40 hover:text-accent transition-colors uppercase tracking-widest text-[10px] font-bold">
                Cookies Policy
              </Link>
            </li>
            <li>
