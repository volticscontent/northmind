    ...
    },
    {
      ...
      label:
        status === "authenticated"
          ...
          : "Login",
      action: () =>
        router.push(status === "authenticated" ? "/user" : "/login"),
      desktopOnly: true,
    },
    {
      id: "cart",
            ...
            {icons.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  className={`flex items-center gap-2 min-h-[44px] min-w-[44px] justify-center rounded-full px-4 transition-all duration-300 ${
